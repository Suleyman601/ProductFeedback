...
const RoadFeedback = ({ title, description, tag, upvotes, comments }) => {
  return (
    <div className="bg-white p-6 rounded-lg text-sm border-t-purple border-t-8">
      <div className="flex items-center mb-4">
        <div className={"w-2 h-2 rounded-full mr-2 bg-purple"}>&nbsp;</div>
        <p>In Progress</p>
      </div>
